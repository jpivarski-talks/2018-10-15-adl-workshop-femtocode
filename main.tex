...
\vspace{1 cm}
{\Large Why do we need a full programming language?}
\end{center}
\end{frame}
...
\vspace{0.15 cm}
\mbox{ } \hfill \texttt{if (x > 0) \{ x**2 \} else \{ -x**2 \}} \hfill \mbox{ }

\vspace{0.15 cm}
becomes \fbox{\texttt{if}} \fbox{\texttt{(}} \fbox{\texttt{x}} \fbox{\texttt{>}} \fbox{\texttt{0}} \fbox{\texttt{)}} \fbox{\texttt{\{}} \fbox{\texttt{x}} \fbox{\texttt{**}} \fbox{\texttt{2}} \fbox{\texttt{\}}} \fbox{\texttt{else}} \fbox{\texttt{\{}} \fbox{\texttt{-}} \fbox{\texttt{x}} \fbox{\texttt{**}} \fbox{\texttt{2}} \fbox{\texttt{\}}}.

\item \textcolor{darkblue}{Parse:} apply rules like \fbox{\texttt{x}} \fbox{\texttt{**}} \fbox{\texttt{2}} $\to$ \begin{tikzpicture}[edge from parent fork right,grow=east,level 1/.style={sibling distance=0.5 cm}]
\node {\texttt{**}}
child { node {\texttt{x}} }
child { node {\texttt{2}} };
\end{tikzpicture}
