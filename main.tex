...
\item \textcolor{darkorange}{\bf Emit LLVM Intermediate Representation (IR)?} Popular these days: LLVM IR is a typed assembly language that compiles to machine code with optimization: get Cling's optimizations for free.
